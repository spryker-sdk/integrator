...
use SprykerSdk\Integrator\Builder\Visitor\RemovePluginFromChainedPluginCollectionVisitor;
use SprykerSdk\Integrator\Transfer\ClassInformationTransfer;
use SprykerSdk\Integrator\Transfer\ClassMetadataTransfer;

class UnwireClassInstanceReturnChainedCollectionModifierStrategy implements UnwireClassInstanceModifierStrategyInterfaceCheck
{
    ...
    {
        return [
            new RemovePluginFromChainedPluginCollectionVisitor($classMetadataTransfer),
        ];
    }
}
