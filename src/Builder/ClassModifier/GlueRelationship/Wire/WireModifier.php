...
namespace SprykerSdk\Integrator\Builder\ClassModifier\GlueRelationship\Wire;
...
class WireModifier extends AbstractModifier implements WireModifierInterface
{
    /**
