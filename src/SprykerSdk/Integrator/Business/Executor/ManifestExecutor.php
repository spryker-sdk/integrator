...
namespace SprykerSdk\Integrator\Business\Executor;
...
{
    /**
     * @var \SprykerSdk\Integrator\Business\SprykerLock\SprykerLockReader
     */
    protected $sprykerLockReader;

    /**
     * @var \SprykerSdk\Integrator\Business\Manifest\ManifestReader
     */
    protected $manifestReader;

    /**
     * @var \SprykerSdk\Integrator\Business\ManifestStrategy\ManifestStrategyInterface[]
     */
    protected $manifestExecutors;

    /**
     * @var \SprykerSdk\Integrator\Business\SprykerLock\SprykerLockWriter
     */
    protected $sprykerLockWriter;

    /**
     * @param \SprykerSdk\Integrator\Business\SprykerLock\SprykerLockReader $sprykerLockReader
     * @param \SprykerSdk\Integrator\Business\Manifest\ManifestReader $manifestReader
     * @param \SprykerSdk\Integrator\Business\SprykerLock\SprykerLockWriter $sprykerLockWriter
     * @param \SprykerSdk\Integrator\Business\ManifestStrategy\ManifestStrategyInterface[] $manifestExecutors
     */
